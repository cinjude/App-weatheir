...
function App() {
  ...
  return (
   ...
   <div className="weither">
    <div className='image-celcius'>
    <img src= { `http://openweathermap.org/img/wn/${weither.weather?.[0].icon}@2x.png` } alt="" />
   <div className='celcius'>  {isCelcius?  trunc  : truncFarenheit } { isUnit? " °C " : " °F "} </div>
    </div>
   <div className='temp'>
    <h4 className='i1'> " Scattered clouds " </h4>
     <div className='i1'><b> Wind speed: </b> { weither.wind?.speed } m/s</div>
    <div className='i1'> <b> Humidity: </b> { weither.main?.humidity } % </div>
     <div className='i1'><b> Pressure: </b> { weither.main?.pressure } mb </div>
   </div>
   </div>
